...
public class TicketDetailsImplTest {
	...
	public void testGenerateTicketDetails() {
		...
		bus.setTrip_date("2023-07-02"); // Corrected date format
		bus.setDepature("09:00:00");
		bus.setArrival("12:00:00");
		...
		// Assert.assertEquals(result.getJourney_date(), "2023-07-03");
		// Assert.assertEquals(result.getDeparture_time(), "09:00:00");
		// Assert.assertEquals(result.getArrival_time(), "12:00:00");
		...
		Assert.assertEquals(result.getTotalFare(), 400.0); // (200 + 300)
		...
		Assert.assertEquals(passenger2.getSeat_fare(), 200.0);
	}
}
