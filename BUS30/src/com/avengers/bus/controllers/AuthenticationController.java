...
import com.avengers.bus.dao.implementation.UserTicketsDaoImpl;
...
public class AuthenticationController {
	...
	@Autowired
	public AuthenticationController(UserService userService, AdminDAO adminDAO) {
		super();
	...
	public String showAdminLogin(@RequestParam("user_name") String user_name, @RequestParam("password") String password,
		...
		Admin admin = adminDAO.findByUserId(user_name);
		if (user_name.equals(admin.getUser_id()) && password.equals(admin.getPassword())) {
